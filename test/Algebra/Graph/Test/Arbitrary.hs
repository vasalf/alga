...
import qualified Algebra.Graph.Bipartite.Undirected.AdjacencyMap.Algorithm as BA
...
instance (Arbitrary a, Arbitrary b, Ord a, Ord b) => Arbitrary (BA.Matching a b) where
    arbitrary = BA.matching <$> arbitrary
